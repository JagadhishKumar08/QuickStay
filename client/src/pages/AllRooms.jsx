...
const AllRooms = () => {
  ...
  return (
    <div
      className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35
    ...
    >
      <div>
        ...
        {roomsDummyData.map(room => (
          <div
            key={room._id}
            className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-b-gray-400 last:pb-[30px] last:border-0'
          >
            <img
              onClick={() => {

...
const HotelCard = ({room,index}) => {
  return (
    <Link to={'/rooms/' + room._id} onClick={()=>scrollTo(0,0)} key={room._id} className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)]'>
       ...
       { index % 2 ===0 && <p className='px-3 py-1 absolute top-3 left-3 text-x5 bg-white text-gray-800 font-medium rounded-full'>
            Best seller</p>}
        <div className='p-4 pt-5 '>
            ...
            <div className='flex items-center justify-between mt-4'>
                <p><span className='text-x1 text-gray-800'>${room.pricePerNight}/Night</span>t</p>
